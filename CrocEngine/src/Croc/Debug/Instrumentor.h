...
#define CROC_PROFILE 1
	...
	#define CROC_PROFILE_FUNCTION() CROC_PROFILE_SCOPE(__FUNCSIG__)
#else
	#define CROC_PROFILE_BEGIN_SESSION(name, filepath)
	#define CROC_PROFILE_END_SESSION()
	#define CROC_PROFILE_SCOPE(name)
	#define CROC_PROFILE_FUNCTION()
#endif